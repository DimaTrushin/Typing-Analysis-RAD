...
#ifndef UnitExtremumFinderH
#define UnitExtremumFinderH
//---------------------------------------------------------------------------
// Include
//---------------------------------------------------------------------------

#include "UnitRootFinder.h"
//---------------------------------------------------------------------------
...
template<class TRootFinder>
template<class TApproximation>
double CExtremumFinderDirectEvaluation<TRootFinder>::
                                  computeMaximumOnInterval0(
                                          const TApproximation& Approximation,
                                          const CInterval& Interval) {
...
template<class TRootFinder>
template<class TApproximation>
bool CExtremumFinderDirectEvaluation<TRootFinder>::
...
template <unsigned int derivative,
          class TApproximation>
double CExtremumFinderTemplateEvaluation<TRootFinder>::
                                computeMaximumOnInterval(
                                    const TApproximation& Approximation,
                                    const CInterval& Interval) {
...
template <unsigned int derivative,
          class TApproximation>
bool CExtremumFinderTemplateEvaluation<TRootFinder>::
