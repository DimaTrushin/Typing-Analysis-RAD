...
#ifndef UnitAnyUIteratorH
#define UnitAnyUIteratorH
//---------------------------------------------------------------------------
// Include
//---------------------------------------------------------------------------
...
public:
    ...
    virtual unsigned short getVKCode() const = 0;
...
public:
  using CBase::CBase;
    ...
    unsigned short getVKCode() const override;
...
using CAnyUIterator = NSLibrary::CAnyObject<CAnyIteratorInterface,
                                            IUIteratorInterface,
