...
#ifndef UnitAnyObjectH
#define UnitAnyObjectH
//---------------------------------------------------------------------------
// Include
//---------------------------------------------------------------------------
...
CAnyObjectBase<TInterface, TImplementation>::
  CAnyObjectBase(const CAnyObjectBase& Other)
...
CAnyObjectBase<TInterface, TImplementation>&
  CAnyObjectBase<TInterface, TImplementation>::
    operator=(const CAnyObjectBase& Other) {
...
template< template<class>class TInterface,
          template<class, class>class TImplementation>
template<class TObject>
std::unique_ptr<typename CAnyObjectBase<TInterface,
                                    TImplementation>::IObjectStored>
  CAnyObjectBase<TInterface, TImplementation>::
