...
//---------------------------------------------------------------------------
// Declaration of CVTreeNode Streaming
//---------------------------------------------------------------------------

template<class TStreamer, class TType>
TStreamer& operator<<(TStreamer& Streamer, const CVTreeNode<TType>& VTreeNode);
//---------------------------------------------------------------------------

template<class TStreamer, class TType>
TStreamer& operator>>(TStreamer& Streamer, CVTreeNode<TType>& VTreeNode);
//---------------------------------------------------------------------------
...
CVTreeBase TreeBase_;
  ...
  template<class TStreamer, class TOtherType>
  friend TStreamer& operator<<( TStreamer& Streamer,
                                const CVTree<TOtherType>& VTree);
  template<class TStreamer, class TOtherType>
  friend TStreamer& operator>>( TStreamer& Streamer,
                                CVTree<TOtherType>& VTree);
};
//---------------------------------------------------------------------------
// Declaration of CVTree Streaming
//---------------------------------------------------------------------------

template<class TStreamer, class TType>
TStreamer& operator<<(TStreamer& Streamer, const CVTree<TType>& VTree);
//---------------------------------------------------------------------------

template<class TStreamer, class TType>
TStreamer& operator>>(TStreamer& Streamer, CVTree<TType>& VTree);
//---------------------------------------------------------------------------
} // NSLibrary
//---------------------------------------------------------------------------
} // NSKernel
...
//---------------------------------------------------------------------------
// Definition of CVTreeNode Streaming
//---------------------------------------------------------------------------

template<class TStreamer, class TType>
TStreamer& operator<<(TStreamer& Streamer, const CVTreeNode<TType>& VTreeNode) {
  Streamer << VTreeNode.Data_;
  Streamer << VTreeNode.Parent_;
  Streamer << VTreeNode.FirstChild_;
  Streamer << VTreeNode.LastChild_;
  Streamer << VTreeNode.PreviousSibling_;
  Streamer << VTreeNode.NextSibling_;
  Streamer << VTreeNode.NumberOfChildren_;
  Streamer << VTreeNode.DistanceToRoot_;
  return Streamer;
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
// Definition of CVTree Streaming
//---------------------------------------------------------------------------

template<class TStreamer, class TType>
TStreamer& operator<<(TStreamer& Streamer, const CVTree<TType>& VTree) {
  Streamer << VTree.TreeBase_;
  return Streamer;
}
//---------------------------------------------------------------------------
