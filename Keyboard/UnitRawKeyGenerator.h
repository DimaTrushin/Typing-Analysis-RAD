...
#ifndef UnitRawKeyGeneratorH
#define UnitRawKeyGeneratorH
//---------------------------------------------------------------------------
// Include
//---------------------------------------------------------------------------
...
public:
  static CRawKey GenerateRawKey(microseconds Time,
                                HKL Layout,
...
private:
  ...
  inline static bool secondBitIsZero(unsigned char Flags);
};
//---------------------------------------------------------------------------
} // NSKeyboard
//---------------------------------------------------------------------------
